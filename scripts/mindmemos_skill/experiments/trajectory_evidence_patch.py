#!/usr/bin/env python3
"""Script-side trajectory-evidence trace2skill run followed by test evaluation."""
...
from mindmemos_skill.typing import Skill, SkillCandidate, Trace2SkillInput, compute_skill_content_hash
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--transcript-max-chars", type=int, default=1500)
    parser.add_argument("--annotation-mode", choices=("auto", "required", "ignore"), default="auto")
    parser.add_argument("--require-skill-match", action=argparse.BooleanOptionalAction, default=True)
    parser.add_argument("--rewrite-skill", action=argparse.BooleanOptionalAction, default=False)
...
async def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    algorithm = TrajectoryEvidencePatch(
        config=config,
    ...
    summary = {
        ...
        "trace2skill": result.report.model_dump(mode="json"),
        "test": test_summary,
    }
