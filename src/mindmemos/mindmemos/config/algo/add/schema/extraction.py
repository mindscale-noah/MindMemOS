...
class SchemaAddExtractionConfig:
    ...
    """Whether schema add stores episode search fields derived from extracted properties (v1 flow)."""
    ...
    """Whether schema add asks the LLM to augment episode search fields (v1 flow)."""

    episode_augment_count: int = field(default=4)
    """Maximum number of LLM-generated supplemental episode search fields (v1 flow)."""
    ...
    """Maximum concurrent entity resolve / property tasks inside one add request (v1 flow)."""
