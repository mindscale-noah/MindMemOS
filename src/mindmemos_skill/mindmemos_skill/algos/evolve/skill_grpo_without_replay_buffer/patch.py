"""Source-prioritized replay-free experience patch proposal."""
...
class PatchProposer:
    ...
    async def propose(self, skill: Skill, experiences: list[ReplayFreeExtractedExperience]) -> PatchProposalRecord:
        if not experiences:
